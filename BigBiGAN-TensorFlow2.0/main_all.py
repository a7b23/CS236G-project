...
from train_all import set_up_train
...
flags.DEFINE_bool('all', False, 'Train on both positives and negatives')
flags.DEFINE_bool('pos', False, 'Train on positive augmentations')
flags.DEFINE_bool('neg', False, 'Train on negatives')
...
def main(argv):
    ...
    if FLAGS.evaluate:
        ...
        wandb.init(config=FLAGS, sync_tensorboard=True, dir="/dfs/scratch2/prabhat8/cs236g/wandb")
        set_up_train(FLAGS)
