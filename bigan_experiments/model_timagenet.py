...
class Generator(nn.Module):
    ...
    def __init__(self, latent_size):
        ...
        self.main = nn.Sequential(
            ...
            nn.ConvTranspose2d(64, 64, 4, stride=2, bias=False),
            nn.BatchNorm2d(64),
            nn.LeakyReLU(inplace=True),

            nn.ConvTranspose2d(64, 32, 4, stride=1, bias=False, padding=1),
            nn.BatchNorm2d(32),
            nn.LeakyReLU(inplace=True),

            nn.ConvTranspose2d(32, 32, 4, stride=2, bias=False),
            nn.BatchNorm2d(32),
            nn.LeakyReLU(inplace=True),
...
class Encoder(nn.Module):
    ...
    def __init__(self, latent_size, noise=False):
        ...
        self.main1 = nn.Sequential(
            ...
            nn.Conv2d(256, 256, 4, stride=2, bias=False),
            nn.BatchNorm2d(256),
            nn.LeakyReLU(inplace=True)
